...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@hebilicious/vue-query-nuxt/dist/runtime/plugin").default> &
  ...
  InjectionType<typeof import("../../plugins/interceptor").default> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'i18n:plugin' | 'nuxt:checkIfLayoutUsed'
  }
}
