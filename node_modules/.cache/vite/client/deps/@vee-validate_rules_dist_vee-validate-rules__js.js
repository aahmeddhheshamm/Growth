import {
  init_vee_validate_esm,
  vee_validate_esm_exports
} from "./chunk-5TEC5RNX.js";
import {
  __commonJS,
  __toCommonJS
...
// node_modules/@vee-validate/rules/dist/vee-validate-rules.js
var require_vee_validate_rules = __commonJS({
  "node_modules/@vee-validate/rules/dist/vee-validate-rules.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require_vue(), (init_vee_validate_esm(), __toCommonJS(vee_validate_esm_exports))) : typeof define === "function" && define.amd ? define(["exports", "vue", "vee-validate"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.VeeValidateRules = {}, global.Vue, global.veeValidate));
    })(exports, function(exports2, vue, veeValidate) {
      "use strict";
      const alpha = {
        en: /^[A-Z]*$/i,
        ...
        const schema = {
          ...
          async parse(values) {
            if (typeof rawSchema === "string") {
              const result2 = await veeValidate.validate(values, rawSchema);
              return {
                errors: [
                  {
      ...
      exports2.alpha = alphaValidator;
      exports2.alpha_dash = alphaDashValidator;
      exports2.alpha_num = alphaNumValidator;
      exports2.alpha_spaces = alphaSpacesValidator;
      exports2.between = betweenValidator;
      exports2.confirmed = confirmedValidator;
      exports2.digits = digitsValidator;
      exports2.dimensions = dimensionsValidator;
      exports2.email = emailValidator;
      exports2.ext = extValidator;
      exports2.image = imageValidator;
      exports2.integer = integerValidator;
      exports2.is = isValidator;
      exports2.is_not = isNotValidator;
      exports2.length = lengthValidator;
      exports2.max = maxLengthValidator;
      exports2.max_value = maxValueValidator;
      exports2.mimes = mimesValidator;
      exports2.min = minValidator;
      exports2.min_value = minValueValidator;
      exports2.not_one_of = notOneOfValidator;
      exports2.numeric = numericValidator;
      exports2.one_of = oneOfValidator;
      exports2.regex = regexValidator;
      exports2.required = requiredValidator;
      exports2.size = sizeValidator;
      exports2.toTypedSchema = toTypedSchema;
      exports2.url = urlValidator;
    });
  }
});
export default require_vee_validate_rules();
/*! Bundled license information:

@vee-validate/rules/dist/vee-validate-rules.js:
  (**
    ...
    *)
*/
//# sourceMappingURL=@vee-validate_rules_dist_vee-validate-rules__js.js.map
