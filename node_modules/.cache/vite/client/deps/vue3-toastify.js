  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        c[t] = n.filter((o) => o.toastId !== e), !c[t].length && !xe(t) && te(t, false), De(), le(() => {
...
function tt({
  ...
  return n ? o = oe.spinner() : a === false ? o = void 0 : G(a) ? o = T(a) : B(a) ? o = a(s) : ie(a) ? o = pe(a, s) : ae(a) || He(a) ? o = a : et(t) && (o = oe[t](s)), o;
}
var nt = () => {
};
...
function ot(e) {
  const t = q(false), n = q(false), a = q(false), o = q(V.Enter), s = w({
    ...e,
...
var st = W({
  ...
  setup(e) {
    ...
    return () => i("div", P({
      ...
      innerHTML: e.content
    }) : e.content])]), (e.closeButton === void 0 || e.closeButton === true) && i(We, {
      theme: e.theme,
      closeToast: (m) => {
